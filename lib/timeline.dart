    ...
    try {
      ...
      tlFuture.then((timeline) =>
      {
        if (mounted) {
          ...
          widget.statuses.forEach((statusElement)
      {
        var content = statusElement.reblog != null
            ? statusElement.reblog!.spoilerText != ""
            ? statusElement.reblog!.spoilerText
            : statusElement.reblog!.content
            : statusElement.spoilerText != ""
            ? statusElement.spoilerText
            : statusElement.content;
        statusElement.emojis.forEach((emoji) {
          debugPrint(emoji.code);
          content = content.replaceAll(":${emoji.code}:", "EMOJI!");
        });
        statusContents.add(content);
      });
    }
    });
                            ...
                            children: [
                              ...
                              Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Visibility(
                                          visible: widget.statuses[i].reblog !=
                                              null,
                                          child: Text(
